...
\newlength{\hppaperwidth} % no. of pages ÷ 2 (rounded up) × width per sheet
...
\begin{document}
\begin{bookcover}
\definecolor{coversbg}{rgb}{0.07843 0.07451 0.09804}
\bookcovercomponent{color}{bg whole}{coversbg}
